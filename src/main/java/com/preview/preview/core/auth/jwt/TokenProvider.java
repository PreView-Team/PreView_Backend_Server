package com.preview.preview.core.auth.jwt;
...
public class TokenProvider implements InitializingBean {
    ...
    public Authentication getAuthentication(String token){
        ...
        return new UsernamePasswordAuthenticationToken(new com.preview.preview.module.user.domain.User(claims), token, authorities);
    }
